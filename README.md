...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/learning.CounterService/GetCurrentCounter -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 learning.CounterService/GetCurrentCounter 
ERROR:
  Code: Unknown
